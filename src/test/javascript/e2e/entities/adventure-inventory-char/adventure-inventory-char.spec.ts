...
describe('AdventureInventoryChar e2e test', () => {
  ...
  it('should load AdventureInventoryChars', async () => {
    ...
    await browser.wait(ec.visibilityOf(adventureInventoryCharComponentsPage.title), 5000);
  ...
  it('should create and save AdventureInventoryChars', async () => {
    ...
    expect(await adventureInventoryCharUpdatePage.getSaveButton().isPresent(), 'Expected save button disappear').to.be.false;

    expect(await adventureInventoryCharComponentsPage.countDeleteButtons()).to.eq(
  ...
  it('should delete last AdventureInventoryChar', async () => {
    ...
    expect(await adventureInventoryCharDeleteDialog.getDialogTitle()).to.eq('adventureGatewayApp.adventureInventoryChar.delete.question');
